    ...
    return (
        ...
        <div className="mt-5" id="main-div">
            ...
            <div className="flex justify-center">
                <div className="flex border-dashed border-2 border-slate-400 w-fit font-sans m-24 p-8 text-center justify-center items-center" onDragOver={(e) => { stopOver(e) }} onDrop={e=>{handleDrop(e)}}>
                    <form className="grid grid-cols-1">
                        ...
                        <input type="file" accept=".zip" className=" hidden input-group w-full border border-gray-300 rounded-lg" onChange={(e)=>handleChangeFiles(e)} />
                        <label>Tu peux drag-and-drop (Uniquement .zip)</label>
                        <button className={`${!hasFile ? "" : "hidden"} input-group mb-1 mt-1 flex w-full border border-gray-300 rounded-lg p-2.5 justify-center`} onClick={chooseFile}>Choisir un fichier</button>

                            <select className="input-group mb-1 mt-1 flex w-full border border-gray-300 rounded-lg p-2.5 justify-center" aria-label="Select a mod" id="mod-sel">
                        ...
                        <button className={`${hasFile ? "" : "hidden"} input-group mb-1 mt-1 flex w-full border border-gray-300 rounded-lg p-2.5 justify-center`} onClick={handleClearClick}>Supprimer</button>
                        <button className={`${hasFile ? "" : "hidden"} input-group mb-1 mt-1 flex w-full border border-gray-300 rounded-lg p-2.5 justify-center`} onClick={handleSendClick}>Envoyer</button>
